...
/**
 * CreateDeviceSwitchRoutingStaticRoute Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateDeviceSwitchRoutingStaticRoute implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'createDeviceSwitchRoutingStaticRoute';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['next_hop_ip'] === null) {
            $invalidProperties[] = "'next_hop_ip' can't be null";
        }
