...
/**
 * CreateNetworkApplianceStaticRoute Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateNetworkApplianceStaticRoute implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'createNetworkApplianceStaticRoute';
     ...
     * Sets name
     *
     * @param string $name The name of the new static route
     *
     * @return $this
     */
