...
/**
 * NetworksnetworkIdwirelessrfProfilesrfProfileIdTwoFourGhzSettings Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworksnetworkIdwirelessrfProfilesrfProfileIdTwoFourGhzSettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'networksnetworkIdwirelessrfProfilesrfProfileId_twoFourGhzSettings';
     ...
     * Sets max_power
     *
     * @param int $max_power Sets max power (dBm) of 2.4Ghz band. Can be integer between 5 and 30.
     *
     * @return $this
     */
     ...
     * Sets min_power
     *
     * @param int $min_power Sets min power (dBm) of 2.4Ghz band. Can be integer between 5 and 30.
     *
     * @return $this
     */
     ...
     * Sets min_bitrate
     *
     * @param float $min_bitrate Sets min bitrate (Mbps) of 2.4Ghz band. Can be one of '1', '2', '5.5', '6', '9', '11', '12', '18', '24', '36', '48' or '54'.
     *
     * @return $this
     */
     ...
     *
     * @param int[] $valid_auto_channels Sets valid auto channels for 2.4Ghz band. Can be one of '1', '6' or '11'.
     *
     * @return $this
     */
     ...
     * Sets ax_enabled
     *
     * @param bool $ax_enabled Determines whether ax radio on 2.4Ghz band is on or off. Can be either true or false. If false, we highly recommend disabling band steering.
     *
     * @return $this
     */
