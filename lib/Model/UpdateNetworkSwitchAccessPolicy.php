...
/**
 * UpdateNetworkSwitchAccessPolicy Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateNetworkSwitchAccessPolicy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateNetworkSwitchAccessPolicy';
     ...
     *
     * @param string $radius_group_attribute Can be either `\"\"`, which means `None` on Dashboard, or `\"11\"`, which means `Filter-Id` on Dashboard and will use Group Policy ACLs when supported (firmware 14+)
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getHostModeAllowableValues();
        if (!is_null($host_mode) && !in_array($host_mode, $allowedValues, true)) {
