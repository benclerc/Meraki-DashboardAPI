...
/**
 * NetworksnetworkIdappliancetrafficShapingrulesPerClientBandwidthLimitsBandwidthLimits Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworksnetworkIdappliancetrafficShapingrulesPerClientBandwidthLimitsBandwidthLimits implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'networksnetworkIdappliancetrafficShapingrules_perClientBandwidthLimits_bandwidthLimits';
     ...
     * Sets limit_up
     *
     * @param int $limit_up The maximum upload limit (integer, in Kbps).
     *
     * @return $this
     */
     ...
     * Sets limit_down
     *
     * @param int $limit_down The maximum download limit (integer, in Kbps).
     *
     * @return $this
     */
