 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworksnetworkIdclientsprovisionPoliciesBySsid0 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'networksnetworkIdclientsprovision_policiesBySsid_0';
     ...
     * Sets device_policy
     *
     * @param string $device_policy The policy to apply to the specified client. Can be 'Allowed', 'Blocked', 'Normal' or 'Group policy'. Required.
     *
     * @return $this
     */
