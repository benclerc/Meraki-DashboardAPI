...
/**
 * UpdateNetworkFloorPlan Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateNetworkFloorPlan implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateNetworkFloorPlan';
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'center' => '\Swagger\Client\Model\NetworksnetworkIdfloorPlansfloorPlanIdCenter',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['image_contents']) && !preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $this->container['image_contents'])) {
     ...
     * Gets center
     *
     * @return \Swagger\Client\Model\NetworksnetworkIdfloorPlansfloorPlanIdCenter
     */
     ...
     * Sets center
     *
     * @param \Swagger\Client\Model\NetworksnetworkIdfloorPlansfloorPlanIdCenter $center center
     *
     * @return $this
     */
     ...
     * Sets image_contents
     *
     * @param string $image_contents The file contents (a base 64 encoded string) of your new image. Supported formats are PNG, GIF, and JPG. Note that all images are saved as PNG files, regardless of the format they are uploaded in. If you upload a new image, and you do NOT specify any new geolocation fields ('center, 'topLeftCorner', etc), the floor plan will be recentered with no rotation in order to maintain the aspect ratio of your new image.
     *
     * @return $this
     */
    public function setImageContents($image_contents)
    {
        ...
        if (!is_null($image_contents) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $image_contents))) {
            throw new \InvalidArgumentException("invalid value for $image_contents when calling UpdateNetworkFloorPlan., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
