...
/**
 * NetworksnetworkIdwirelessssidsnumberDnsRewrite Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworksnetworkIdwirelessssidsnumberDnsRewrite implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'networksnetworkIdwirelessssidsnumber_dnsRewrite';
     ...
     * Sets enabled
     *
     * @param bool $enabled Boolean indicating whether or not DNS server rewrite is enabled. If disabled, upstream DNS will be used
     *
     * @return $this
     */
     ...
     *
     * @param string[] $dns_custom_nameservers User specified DNS servers (up to two servers)
     *
     * @return $this
     */
