...
/**
 * CreateOrganizationSamlRole Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateOrganizationSamlRole implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'createOrganizationSamlRole';
    ...
    protected static $swaggerTypes = [
        'role' => 'string',
        'org_access' => 'string',
        'tags' => '\Swagger\Client\Model\OrganizationsorganizationIdsamlRolesTags[]',
        'networks' => '\Swagger\Client\Model\OrganizationsorganizationIdsamlRolesNetworks[]'
    ];
     ...
     * Sets org_access
     *
     * @param string $org_access The privilege of the SAML administrator on the organization. Can be one of 'none', 'read-only' or 'full'
     *
     * @return $this
     */
     ...
     * Gets tags
     *
     * @return \Swagger\Client\Model\OrganizationsorganizationIdsamlRolesTags[]
     */
     ...
     * Sets tags
     *
     * @param \Swagger\Client\Model\OrganizationsorganizationIdsamlRolesTags[] $tags The list of tags that the SAML administrator has privleges on
     *
     * @return $this
     */
     ...
     * Gets networks
     *
     * @return \Swagger\Client\Model\OrganizationsorganizationIdsamlRolesNetworks[]
     */
     ...
     * Sets networks
     *
     * @param \Swagger\Client\Model\OrganizationsorganizationIdsamlRolesNetworks[] $networks The list of networks that the SAML administrator has privileges on
     *
     * @return $this
     */
