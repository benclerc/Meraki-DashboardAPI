 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateNetworkSwitchStackRoutingInterfaceDhcp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateNetworkSwitchStackRoutingInterfaceDhcp';
     ...
     * Sets dhcp_mode
     *
     * @param string $dhcp_mode The DHCP mode options for the switch stack interface ('dhcpDisabled', 'dhcpRelay' or 'dhcpServer')
     *
     * @return $this
     */
     ...
     *
     * @param string[] $dhcp_relay_server_ips The DHCP relay server IPs to which DHCP packets would get relayed for the switch stack interface
     *
     * @return $this
     */
     ...
     *
     * @param string $dhcp_lease_time The DHCP lease time config for the dhcp server running on switch stack interface ('30 minutes', '1 hour', '4 hours', '12 hours', '1 day' or '1 week')
     *
     * @return $this
     */
     ...
     *
     * @param string $dns_nameservers_option The DHCP name server option for the dhcp server running on the switch stack interface ('googlePublicDns', 'openDns' or 'custom')
     *
     * @return $this
     */
     ...
     *
     * @param string $boot_next_server The PXE boot server IP for the DHCP server running on the switch stack interface
     *
     * @return $this
     */
     ...
     * Sets boot_file_name
     *
     * @param string $boot_file_name The PXE boot server file name for the DHCP server running on the switch stack interface
     *
     * @return $this
     */
     ...
     * Sets dhcp_options
     *
     * @param \Swagger\Client\Model\DevicesserialswitchroutinginterfacesinterfaceIddhcpDhcpOptions[] $dhcp_options Array of DHCP options consisting of code, type and value for the DHCP server running on the switch stack interface
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\DevicesserialswitchroutinginterfacesinterfaceIddhcpReservedIpRanges[] $reserved_ip_ranges Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\DevicesserialswitchroutinginterfacesinterfaceIddhcpFixedIpAssignments[] $fixed_ip_assignments Array of DHCP fixed IP assignments for the DHCP server running on the switch stack interface
     *
     * @return $this
     */
