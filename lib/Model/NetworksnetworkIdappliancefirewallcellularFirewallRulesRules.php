...
/**
 * NetworksnetworkIdappliancefirewallcellularFirewallRulesRules Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworksnetworkIdappliancefirewallcellularFirewallRulesRules implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'networksnetworkIdappliancefirewallcellularFirewallRules_rules';
     ...
     * Sets src_cidr
     *
     * @param string $src_cidr Comma-separated list of source IP address(es) (in IP or CIDR notation), or 'any' (note: FQDN not supported for source addresses)
     *
     * @return $this
     */
