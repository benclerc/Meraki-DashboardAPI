 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateNetworkWirelessRfProfile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'createNetworkWirelessRfProfile';
    ...
    protected static $swaggerTypes = [
        ...
        'ap_band_settings' => '\Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesApBandSettings',
        'two_four_ghz_settings' => '\Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesTwoFourGhzSettings',
        'five_ghz_settings' => '\Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesFiveGhzSettings'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['band_selection_type'] === null) {
            $invalidProperties[] = "'band_selection_type' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name The name of the new profile. Must be unique. This param is required on creation.
     *
     * @return $this
     */
     ...
     *
     * @param bool $client_balancing_enabled Steers client to best available access point. Can be either true or false. Defaults to true.
     *
     * @return $this
     */
     ...
     *
     * @param string $min_bitrate_type Minimum bitrate can be set to either 'band' or 'ssid'. Defaults to band.
     *
     * @return $this
     */
     ...
     *
     * @param string $band_selection_type Band selection can be set to either 'ssid' or 'ap'. This param is required on creation.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getBandSelectionTypeAllowableValues();
        if (!in_array($band_selection_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'band_selection_type', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @return \Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesApBandSettings
     */
     ...
     *
     * @param \Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesApBandSettings $ap_band_settings ap_band_settings
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesTwoFourGhzSettings
     */
     ...
     *
     * @param \Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesTwoFourGhzSettings $two_four_ghz_settings two_four_ghz_settings
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesFiveGhzSettings
     */
     ...
     *
     * @param \Swagger\Client\Model\NetworksnetworkIdwirelessrfProfilesFiveGhzSettings $five_ghz_settings five_ghz_settings
     *
     * @return $this
     */
