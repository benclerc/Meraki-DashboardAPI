...
/**
 * UpdateNetworkGroupPolicy Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateNetworkGroupPolicy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateNetworkGroupPolicy';
     ...
     * Sets name
     *
     * @param string $name The name for your group policy.
     *
     * @return $this
     */
