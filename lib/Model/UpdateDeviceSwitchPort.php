 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateDeviceSwitchPort implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateDeviceSwitchPort';
     ...
     * Sets tags
     *
     * @param string[] $tags The list of tags of the switch port
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of the switch port ('trunk' or 'access')
     *
     * @return $this
     */
     ...
     * Sets vlan
     *
     * @param int $vlan The VLAN of the switch port. A null value will clear the value set for trunk ports.
     *
     * @return $this
     */
     ...
     * Sets allowed_vlans
     *
     * @param string $allowed_vlans The VLANs allowed on the switch port. Only applicable to trunk ports.
     *
     * @return $this
     */
     ...
     *
     * @param string $link_negotiation The link speed for the switch port
     *
     * @return $this
     */
     ...
     *
     * @param string $access_policy_type The type of the access policy of the switch port. Only applicable to access ports. Can be one of 'Open', 'Custom access policy', 'MAC allow list' or 'Sticky MAC allow list'
     *
     * @return $this
     */
