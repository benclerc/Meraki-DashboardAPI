...
/**
 * UpdateNetworkApplianceSingleLan Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateNetworkApplianceSingleLan implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateNetworkApplianceSingleLan';
     ...
     * Sets subnet
     *
     * @param string $subnet The subnet of the single LAN configuration
     *
     * @return $this
     */
     ...
     * Sets appliance_ip
     *
     * @param string $appliance_ip The appliance IP address of the single LAN
     *
     * @return $this
     */
