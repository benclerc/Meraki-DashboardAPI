 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworksnetworkIdwirelessrfProfilesFiveGhzSettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'networksnetworkIdwirelessrfProfiles_fiveGhzSettings';
     ...
     * Sets max_power
     *
     * @param int $max_power Sets max power (dBm) of 5Ghz band. Can be integer between 8 and 30. Defaults to 30.
     *
     * @return $this
     */
     ...
     * Sets min_power
     *
     * @param int $min_power Sets min power (dBm) of 5Ghz band. Can be integer between 8 and 30. Defaults to 8.
     *
     * @return $this
     */
     ...
     *
     * @param int[] $valid_auto_channels Sets valid auto channels for 5Ghz band. Can be one of '36', '40', '44', '48', '52', '56', '60', '64', '100', '104', '108', '112', '116', '120', '124', '128', '132', '136', '140', '144', '149', '153', '157', '161' or '165'.Defaults to [36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 144, 149, 153, 157, 161, 165].
     *
     * @return $this
     */
     ...
     * Sets channel_width
     *
     * @param string $channel_width Sets channel width (MHz) for 5Ghz band. Can be one of 'auto', '20', '40' or '80'. Defaults to auto.
     *
     * @return $this
     */
