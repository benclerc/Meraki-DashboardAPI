...
/**
 * UpdateNetworkSwitchStackRoutingInterface Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateNetworkSwitchStackRoutingInterface implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateNetworkSwitchStackRoutingInterface';
    ...
    protected static $swaggerTypes = [
        ...
        'vlan_id' => 'int',
        'ospf_settings' => '\Swagger\Client\Model\DevicesserialswitchroutinginterfacesinterfaceIdOspfSettings'
    ];
     ...
     * Sets interface_ip
     *
     * @param string $interface_ip The IP address this switch stack will use for layer 3 routing on this VLAN or subnet. This cannot be the same as the switch's management IP.
     *
     * @return $this
     */
     ...
     *
     * @param string $multicast_routing Enable multicast support if, multicast routing between VLANs is required. Options are, 'disabled', 'enabled' or 'IGMP snooping querier'.
     *
     * @return $this
     */
     ...
     * Gets ospf_settings
     *
     * @return \Swagger\Client\Model\DevicesserialswitchroutinginterfacesinterfaceIdOspfSettings
     */
     ...
     * Sets ospf_settings
     *
     * @param \Swagger\Client\Model\DevicesserialswitchroutinginterfacesinterfaceIdOspfSettings $ospf_settings ospf_settings
     *
     * @return $this
     */
