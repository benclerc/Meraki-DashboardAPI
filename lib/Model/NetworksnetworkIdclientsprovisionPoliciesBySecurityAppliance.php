...
/**
 * NetworksnetworkIdclientsprovisionPoliciesBySecurityAppliance Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworksnetworkIdclientsprovisionPoliciesBySecurityAppliance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'networksnetworkIdclientsprovision_policiesBySecurityAppliance';
     ...
     * Sets device_policy
     *
     * @param string $device_policy The policy to apply to the specified client. Can be 'Allowed', 'Blocked' or 'Normal'. Required.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDevicePolicyAllowableValues();
        if (!is_null($device_policy) && !in_array($device_policy, $allowedValues, true)) {
