...
/**
 * CreateNetworkCameraQualityRetentionProfile Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateNetworkCameraQualityRetentionProfile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'createNetworkCameraQualityRetentionProfile';
     ...
     * Sets name
     *
     * @param string $name The name of the new profile. Must be unique. This parameter is required.
     *
     * @return $this
     */
