<?php
/**
 * NetworksnetworkIdappliancetrafficShapingGlobalBandwidthLimits
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * NetworksnetworkIdappliancetrafficShapingGlobalBandwidthLimits Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworksnetworkIdappliancetrafficShapingGlobalBandwidthLimits implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'networksnetworkIdappliancetrafficShaping_globalBandwidthLimits';
     ...
     * Sets limit_up
     *
     * @param int $limit_up The upload bandwidth limit in Kbps. (0 represents no limit.)
     *
     * @return $this
     */
     ...
     * Sets limit_down
     *
     * @param int $limit_down The download bandwidth limit in Kbps. (0 represents no limit.)
     *
     * @return $this
     */
