...
/**
 * UpdateDeviceWirelessBluetoothSettings Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateDeviceWirelessBluetoothSettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateDeviceWirelessBluetoothSettings';
     ...
     * Sets uuid
     *
     * @param string $uuid Desired UUID of the beacon. If the value is set to null it will reset to Dashboard's automatically generated value.
     *
     * @return $this
     */
